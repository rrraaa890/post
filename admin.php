...
<form method="get" action="http://localhost:8888/download.php">
    <select name="limit">
...
<article>
    <div class="info">
        ...
        <p><a href="http://localhost:8888/edit.php?message_id=<?php echo $value['id']; ?>">編集</a></p>
        <p><a href="http://localhost:8888/delete.php?message_id=<?php echo $value['id']; ?>">消去</a></p>
    </div>
